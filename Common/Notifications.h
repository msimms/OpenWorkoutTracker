...
#define NOTIFICATION_NAME_PLANNED_WORKOUT_UPDATED  "PlannedWorkoutUpdated"
#define NOTIFICATION_NAME_INTERVAL_WORKOUT_UPDATED "IntervalWorkoutUpdated"
#define NOTIFICATION_NAME_PACE_PLANS_UPDATED       "PacePlansUpdated"
