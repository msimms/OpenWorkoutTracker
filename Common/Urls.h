...
#define REMOTE_API_LIST_GEAR_URL                 "api/1.0/list_gear"
...
#define REMOTE_API_CREATE_TAG_URL                "api/1.0/create_tags_on_activity"
#define REMOTE_API_DELETE_TAG_URL                "api/1.0/delete_tag_from_activity"
