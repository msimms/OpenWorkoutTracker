...
#define STR_DESCRIPTION           NSLocalizedString(@"Description", nil)
...
#define STR_NAME                  NSLocalizedString(@"Name", nil)
...
#define STR_REQUEST_FAILED        NSLocalizedString(@"Request failed!", nil)
