...
- (void)draw
{
	...
	if (self->points)
	{
		...
		if ([appDelegate loadHistoricalActivitySensorData:SENSOR_TYPE_LOCATION forActivityId:self->activityId withCallback:SpeedDataCallback withContext:(__bridge void*)self])
		{
			[super draw];
		}
	}
