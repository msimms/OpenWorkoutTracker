...
std::string MovingActivity::GetSocialNetworkStartingPostStr() const
{
	...
	str << "Started " << name << " at " << timeStr << " (Tweet auto-generated by Exert App)!";
	return str.str();
}
...
std::string MovingActivity::GetSocialNetworkStoppingPostStr() const
{
	...
	str << "Finished " << name << " in " << timeStr << " (Tweet auto-generated by Exert App)!";
	return str.str();
}

std::string MovingActivity::GetSocialNetworkSplitPostStr() const
{
	std::ostringstream str;
	std::string timeStr = FormatTimeStr(ElapsedTimeInSeconds());
	int distance = (int)DistanceTraveled();

	str << distance << " " << UnitMgr::GetPreferredDistanceLabel() << " split time of " << timeStr << ".";
	return str.str();
}
